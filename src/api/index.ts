 ...
 */
export { default as HttpMethodFactory } from './http-method-factory';

/**
 * Reference to the template builder class.
 */
export { default as TemplateBuilder } from './template-builder';
